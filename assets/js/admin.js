...
const starterContent = {
  settings: {
    ...
    header: {
      ...
      ctaVisible: true,
      nav: {
        home: { label: "Home", url: "#home", visible: true },
        about: { label: "About", url: "#about", visible: true },
        services: { label: "Services", url: "#services", visible: true },
        gallery: { label: "Gallery", url: "#gallery", visible: true },
        testimonials: { label: "Testimonials", url: "#testimonials", visible: true },
        publications: { label: "Publications", url: "#publications", visible: true },
        faq: { label: "FAQ", url: "#faq", visible: true },
    ...
    hero: {
      ...
      imageUrl: "https://images.unsplash.com/photo-1588776814594-6d444894210e?auto=format&fit=crop&w=1100&q=80",
      imageAlt: "Dental surgeon treating a patient in a modern clinic",
      topBadgeText: "Sterile Surgical Suite",
      topBadgeIcon: "shield-check",
      topBadgeVisible: true,
      bottomBadgeText: "Smile Makeovers",
      bottomBadgeIcon: "sparkles",
      bottomBadgeVisible: true,
      trust1Title: "Senior Registrar Prosthodontist",
      trust1Subtitle: "SCFHS (14RD0039936)",
      trust1Visible: true,
      trust2Title: "500+ Implant Restorations",
      trust2Subtitle: "Single-unit and full-arch experience",
      trust2Visible: true,
      trust3Title: "1000+ Crowns & Veneers",
      trust3Subtitle: "Fixed prosthodontics and smile design",
      trust3Visible: true,
    ...
    homeHighlights: {
      item1Icon: "microscope",
      item1Text: "Digital Implant Planning",
      item1Visible: true,
      item2Icon: "heart-pulse",
      item2Text: "Full Mouth Rehabilitation",
      item2Visible: true,
      item3Icon: "clock-3",
      item3Text: "Academic & Hospital-Based Experience",
      item3Visible: true,
    },
    about: {
      sectionVisible: true,
      ...
      profileImageUrl: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&w=900&q=80",
      profileImageAlt: "Dentist reviewing a dental X-ray before treatment planning",
      profileSummary:
      ...
      consultationLinkUrl: "#appointment",
      consultationLinkVisible: true,
      cvLinkText: "Download professional CV",
      cvLinkUrl: "assets/docs/asif-mushtaq-prosthodontist-cv.pdf",
      cvLinkVisible: true,
      credential1Icon: "graduation-cap",
      credential1Title: "Education",
      credential1Description: "FCPS Prosthodontics from College of Physicians & Surgeons Pakistan and BDS from de'Montmorency College of Dentistry.",
      credential1Visible: true,
      credential2Icon: "award",
      credential2Title: "Licensure",
      credential2Description: "SCFHS (14RD0039936) licensed Senior Registrar Prosthodontist with consultant eligibility expected in July 2026.",
      credential2Visible: true,
      credential3Icon: "briefcase-medical",
      credential3Title: "Experience",
      credential3Description: "Assistant Professor and Senior Registrar experience across Lahore and Riyadh with complex prosthodontic case planning.",
      credential3Visible: true,
      timeline1Label: "2010-2016",
      timeline1Text: "House Surgeon and General Dental Practitioner experience in Lahore and Riyadh.",
      timeline1Visible: true,
      timeline2Label: "2023",
      timeline2Text: "Completed FCPS Prosthodontics after postgraduate residency at Punjab Dental Hospital.",
      timeline2Visible: true,
      timeline3Label: "2024-Current",
      timeline3Text: "Senior Registrar in Riyadh and Assistant Professor at Akhtar Saeed Medical & Dental College.",
