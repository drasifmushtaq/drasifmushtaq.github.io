...
test("public site is wired for Firebase CMS hydration and appointment storage", () => {
  ...
  assert.match(html, /data-cms-link-field="header\.ctaUrl"/);
  assert.match(html, /data-cms-visible-field="header\.nav\.publications\.visible"/);
  assert.match(html, /data-cms-field="hero\.headline"/);
  assert.match(html, /data-cms-field="hero\.eyebrow"/);
  assert.match(html, /data-cms-src-field="hero\.imageUrl"/);
  assert.match(html, /data-cms-alt-field="hero\.imageAlt"/);
  assert.match(html, /data-cms-field="hero\.topBadgeText"/);
  assert.match(html, /data-cms-icon-field="hero\.topBadgeIcon"/);
  assert.match(html, /data-cms-field="hero\.trust1Title"/);
  assert.match(html, /data-cms-field="homeHighlights\.item1Text"/);
  assert.match(html, /data-cms-icon-field="homeHighlights\.item1Icon"/);
  ...
  assert.match(siteCms, /applyImageSettings/);
  assert.match(siteCms, /applyIconSettings/);
...
test("admin dashboard and Firebase modules exist with required capabilities", () => {
  ...
  assert.match(admin, /name="header\.subtitle"/);
  assert.match(admin, /name="header\.ctaText"/);
  assert.match(admin, /name="header\.ctaUrl"/);
  assert.match(admin, /name="header\.ctaVisible"/);
  assert.match(admin, /name="header\.nav\.publications\.visible"/);
  assert.match(admin, /name="hero\.eyebrow"/);
  assert.match(admin, /name="hero\.imageUrl"/);
  assert.match(admin, /name="hero\.imageAlt"/);
  assert.match(admin, /name="hero\.topBadgeIcon"/);
  assert.match(admin, /name="hero\.topBadgeText"/);
  assert.match(admin, /name="hero\.trust1Title"/);
  assert.match(admin, /name="homeHighlights\.item1Icon"/);
  assert.match(admin, /name="homeHighlights\.item1Text"/);
  ...
  assert.match(html, /data-cms-field="about\.eyebrow"/);
  assert.match(html, /data-cms-src-field="about\.profileImageUrl"/);
  assert.match(html, /data-cms-alt-field="about\.profileImageAlt"/);
  assert.match(html, /data-cms-link-field="about\.consultationLinkUrl"/);
  assert.match(html, /data-cms-visible-field="about\.consultationLinkVisible"/);
  assert.match(html, /data-cms-link-field="about\.cvLinkUrl"/);
  assert.match(html, /data-cms-visible-field="about\.cvLinkVisible"/);
  assert.match(html, /data-cms-icon-field="about\.credential1Icon"/);
  assert.match(html, /data-cms-field="about\.credential1Title"/);
  assert.match(html, /data-cms-field="about\.credential1Description"/);
  assert.match(html, /data-cms-visible-field="about\.credential1Visible"/);
  assert.match(html, /data-cms-field="about\.timeline1Label"/);
  assert.match(html, /data-cms-field="about\.timeline1Text"/);
  assert.match(html, /data-cms-visible-field="about\.timeline1Visible"/);
  assert.match(adminJs, /credential1Title:\s*"Education"/);
  assert.match(adminJs, /timeline1Label:\s*"2010-2016"/);
  assert.match(admin, /name="about\.eyebrow"/);
  assert.match(admin, /name="about\.profileImageUrl"/);
  assert.match(admin, /name="about\.consultationLinkUrl"/);
  assert.match(admin, /name="about\.cvLinkVisible"/);
  assert.match(admin, /name="about\.credential1Icon"/);
  assert.match(admin, /name="about\.credential1Title"/);
  assert.match(admin, /name="about\.credential1Description"/);
  assert.match(admin, /name="about\.timeline1Label"/);
  assert.match(admin, /name="about\.timeline1Text"/);
